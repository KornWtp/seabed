...
class VietnameseMultilingualNLI26lang2mil7PairClassification(AbsTaskPairClassification):
    @property
    def description(self):
        return {
            "name": "VietnameseMultilingualNLI26lang2mil7PairClassification",
            "hf_hub_name": "kornwtp/vi-multilingual-nli-26lang-2mil7",
