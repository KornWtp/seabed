...
class WangchanXSyntheticInstructThai120k_tha_InstructionRetrieval(AbsTaskInstructionRetrieval):
    @property
    def description(self):
        return {
            "name": "WangchanXSyntheticInstructThai120k_tha_InstructionRetrieval",
            "hf_hub_name": "kornwtp/wangchanx-synthetic-instruct120k-tha-instructionretrieval",
