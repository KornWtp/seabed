...
TASK_LIST = [
    "ThaiLimeSodaClassification",
    "ThaiKrathu500Classification",
    "ThaiSEATranslationeseResampledClassification",
    "VietnameseSIB200Classification",
    "VietnameseSpamReviewsClassification",
    "VietnameseUITVSMECClassification",
    "VietnameseViOCDClassification",
    "VietnameseUITVIONClassification",
    "VietnamesePhoATISClassification",
    "VietnameseUITViHSDClassification",
    "VietnameseUITViCTSDClassification",
    "VietnameseUITViSFDClassification",
    "VietnameseUITVSFCClassification",
    "VietnameseSEATranslationeseResampledClassification",
    "TagalogSIB200Classification",
    "EMoTES3KClassification",
    "FilipinoTiktokHatespeechClassification",
    "TyphoonYolandaTweetsClassification",
    "FilipinoLazadaReviewClassification",
    "TagalogSEATranslationeseResampledClassification",
    "MalayTweetsClassification",
    "MalaySEATranslationeseResampledClassification",
    "KhmerSIB200Classification",
    "KhmerSEATranslationeseResampledClassification",
    ...
    "ThaiMIRACLQARetrieval",
    "ThaiTyDiQAQARetrieval",
    "ThaiMLDRQARetrieval",
    "ThaiWikiQAQARetrieval",
    "WangchanXLegalThaiCCLRAGQARetrieval",
    "WangchanXSyntheticInstructThai120kQARetrieval",
    "IndoMIRACLEQARetrieval"
    "IndoTyDiQAQARetrieval"
    ...
    "TamilIndicQAQARetrieval",
    "IndoNetifierMultiLabelClassification",
    "GKLMIPNewsMultiLabelClassification",
    "BurmeseAskCovidDrBotQARetrieval",
    "BurmeseQEDBitextMining",
]
